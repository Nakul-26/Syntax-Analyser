...
def main():
    ...
    parse_cases = [
        ...
        ("int a; int c; a = +c;", True),
        ("char flag; int a; if(!flag) a=1;", True),
        ("int i; int x; x = ++i;", True),
        ("int j; int y; y = j--;", True),
        ("int i; int j; int x; x = ++i + j--;", True),
    ]
    ...
    error_cases = [
        ...
        ("++5;", ("Expected increment target", "5", 2)),
        ("int i; i++++;", ("Expected ';'", "++", 6)),
        ("--;", ("Expected increment target", ";", 2)),
    ]
